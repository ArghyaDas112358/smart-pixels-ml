"""
Performance plots for the BEST SIMPLE (option D) discovery seed.
...
Outputs 8 PNGs + perf_summary.json to runs/perf_plots_simplerouter/.
...
RUN = os.path.join(R, "runs", "simplerouter_discovery")
...
SEEDS = [4042]   # best NLL of the six converged seeds
...
for seed in SEEDS:
    ...
    sp = os.path.join(OUT, f"summary_simple_seed{seed}.png")
    pp = os.path.join(OUT, f"pull_simple_seed{seed}.png")

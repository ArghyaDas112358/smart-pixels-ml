...
OUT = "/work/users/das214/SmartPixels/smart-pixels-ml/runs/part1_long_1_6_iid_contained"
...
def report(runs, made):
    ...
    w(f"> **{note}.** Auto-regenerated from `runs/part1_long_1_6_iid_contained/seed_*/`. "

...
OUT = "/work/users/das214/SmartPixels/smart-pixels-ml/runs/part1_long_2_5_clean_contained"
...
CLEAN = [0.40, 7.00, 30.45]   # converged 5000-ep FULL-set no-noise medians, for reference
...
def report(runs, made):
    ...
    w(f"> **{note}.** Auto-regenerated from `runs/part1_long_2_5_clean_contained/seed_*/`. "

"""
Generate BAKED-NOISE, CONTAINED-cluster TFRecords for the new mV 3srb dataset.
...
OUT_DIR = os.path.join(BASE, "TFR_files_2_5_noise_corr_contained" + ("_SMOKE" if SMOKE else ""))
